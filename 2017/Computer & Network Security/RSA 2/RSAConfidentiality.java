...
public class RSAConfidentiality {
    ...
    /* next, store the keys to files, read them back from files, 
       and then, encrypt & decrypt using the keys from files. */
        ...
        saveToFile("RSAPublic.key", pubKSpec.getModulus(), pubKSpec.getPublicExponent());
        saveToFile("RSAPrivate.key", privKSpec.getModulus(), privKSpec.getPrivateExponent());
 ...
 //       Path path = Paths.get("RSAPublic.key");
//        System.out.println("Absolute path: " + path.toAbsolutePath());
    ...
    public static PrivateKey readPrivKeyFromFile(String keyFileName)
        ...
        InputStream in = RSAConfidentiality.class.getResourceAsStream(keyFileName);
        ObjectInputStream oin = new ObjectInputStream(new BufferedInputStream(in));
